...
(1, 'Bill', 1, NULL, NULL),
(2, 'Domain', 1, NULL, NULL),
(3, 'Hosting', 1, NULL, NULL);
...
(5, '2022_01_15_094030_create_permission_tables', 2),
(6, '2022_01_15_100633_create_category_tables', 2),
(7, '2022_01_16_163643_cerate_priority_table', 2),
(8, '2022_01_16_180329_create_settings_table', 2),
(9, '2022_01_17_081943_create_service_table', 3),
(10, '2022_01_17_125148_create_user_details_table', 4),
(13, '2022_01_18_045818_create_tickets_table', 5),
(14, '2022_01_18_054802_create_ticket_replies_table', 5),
(15, '2022_01_19_154022_create_jobs_table', 6);
...
INSERT INTO `priorities` (`id`, `name`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'High', 1, NULL, NULL),
...
(1, 'Hosting', 1, '2022-01-17 02:57:15', '2022-01-17 02:57:30');
...
CREATE TABLE `settings` (
  ...
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `footerText` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `largeLogo` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `smallLogo` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tickets` (
  ...
  `last_replay_by` bigint(20) UNSIGNED NOT NULL,
